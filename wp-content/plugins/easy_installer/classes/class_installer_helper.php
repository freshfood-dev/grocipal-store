...
class EASYFInstallerHelper
	{
		...
		static function setOptions()
		{
            ...
            $input = base64_decode($easy_metadata['data']->options);  
			
            $input = easy_update_url($input);
		...
		static function setHomePage()
		{
            ...
            if(isset($easy_metadata['data']->blog_page)) :

               $page = get_page_by_title( html_entity_decode($easy_metadata['data']->blog_page) );
		...
		static function setWidgets()
		{
			...
			$widgets = json_decode(easy_update_url(base64_decode($easy_metadata['data']->sidebar_widgets)),true);

			update_option('sidebars_widgets',$widgets);


			$inputs = easy_update_url(base64_decode($easy_metadata['data']->widgets_data));	
